						...
						<div class="m-portlet__body">							
							<div class="form-group m-form__group row">
								...
								<div class="col-lg-4">
									...
									<input type="text" name="procedure_cost" readonly class="form-control m-input" disabled="disabled" value="{{ $payment->procedure_cost }}" style="font-weight: 600px !important;">
								</div>
								...
								<div class="col-lg-4">
									...
									<input type="text" name="amount_due" readonly class="form-control m-input" disabled="disabled" value="{{ $payment->balance }}" style="font-weight: 600px !important;">
								</div>
