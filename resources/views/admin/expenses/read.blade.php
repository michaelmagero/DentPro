                        ...
                        <div class="m-portlet m-portlet--full-height m-portlet--tabs  ">
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="m_user_profile_tab_1">
                                    <form class="m-form m-form--fit m-form--label-align-right" method="POST" action="/update-expense-admin/{{ $expense->id }} ">
                                        {{ csrf_field() }}
                                        <div class="m-portlet__body">
                                            ...
                                            <div class="form-group m-form__group row">
                                                ...
                                                <div class="col-7">
                                                    <input class="form-control m-input" name="description"  type="text" value="{{ $expense->description }}" disabled="disabled">
                                                </div>
                                            </div>
                                            <div class="form-group m-form__group row">
                                                <label for="example-text-input" class="col-2 col-form-label">
                                                ...
                                                <div class="col-7">
                                                    <input class="form-control m-input" name="amount"  type="text" value="{{ $expense->amount }}" disabled="disabled">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="m-portlet__foot m-portlet__foot--fit">
                                            <div class="m-form__actions">
                                                <div class="row">
                                                    <div class="col-2"></div>
                                                    <div class="col-7">
                                                        <a href="{{ url('/edit-expense-admin/'.$expense->id) }}" type="reset" class="btn btn-primary m-btn m-btn--air m-btn--custom">
                                                            Edit Expense
                                                        </a>
                                                        &nbsp;&nbsp;
